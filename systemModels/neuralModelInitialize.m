...
dynamicSystem.config.outNet.nInputs=dynamicSystem.config.nStates*dynamicSystem.ntrans+dataSet.config.nodeLabelsDim;
...
for nt = 1:dynamicSystem.ntrans
    [dynamicSystem.parameters.transitionNet(nt),dynamicSystem.config.transitionNet]=initializeNet(dynamicSystem.config.transitionNet);
end
